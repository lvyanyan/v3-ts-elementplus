...
const formConfig=[
    {label:'用户账号:',prop:'userLoginNm',type:'input',width:'80px',valueWidth:'200px', placeholder:'请输入'},
    ...
    {label:'用户状态:',prop:'status',type:'select',width:'80px',valueWidth:'200px', placeholder:'请选择',domain:'status'},
];
const btnConfig=[
...
const createRules = {
    userLoginNm:[{required:true,message:'帐号不能为空',trigger:'blur'}],
...
const createConfig = [
    {label:'账号', prop:'userLoginNm',type:'input',width:'120px',valueWidth:'200px', placeholder:'请输入账号', required:true,},
