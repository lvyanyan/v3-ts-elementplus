...
function http(axiosConfig: AxiosRequestConfig<any>, customOptions: any, loadingOptions: Partial<Omit<LoadingOptionsResolved, "target" | "parent"> & { target: string | HTMLElement; body: boolean; }> | undefined) {
